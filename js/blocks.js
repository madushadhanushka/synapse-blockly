...
{
  "type": "proxy",
  "message0": "%1 %2 Start On Load %3 %4 Statistics %5 %6 Trace %7 %8 Transport %9 In Sequence %10 Out Sequence %11 Error Sequence %12",
  "args0": [
    {
...
{
  "type": "log",
  "message0": "Log Full %1 Category %2",
  "args0": [
    {
      "type": "input_dummy"
    },
...
{
  "type": "log_custom",
  "message0": "Log Custom %1 Category %2 %3 Properties %4",
  "args0": [
    {
      "type": "input_dummy"
    },
...
},
{
  ...
  "message0": "Property %1 Key %2 Expression %3",
  "args0": [
    {
      "type": "input_dummy"
    },
...
{
  "type": "property_value",
  "message0": "Property %1 Key %2 Value %3",
  "args0": [
    {
      "type": "input_dummy"
    },
...
{
  "type": "filter",
  "message0": "IF Xpath %1 Then %2 Else %3",
  "args0": [
    {
      "type": "input_value",
      "name": "NAME",
...
Blockly.JavaScript['proxy'] = function(block) {
  var value_proxy_name = Blockly.JavaScript.valueToCode(block, 'proxy_name', Blockly.JavaScript.ORDER_ATOMIC);
  var dropdown_start_on_load_dropdown = block.getFieldValue('start_on_load_dropdown');
  var dropdown_statiscs_dropdown = block.getFieldValue('statiscs_dropdown');
  var dropdown_trace_dropdown = block.getFieldValue('trace_dropdown');
  var value_proxy_transport = Blockly.JavaScript.valueToCode(block, 'proxy_transport', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_in_sequence = Blockly.JavaScript.statementToCode(block, 'in_sequence');
  var statements_out_sequence = Blockly.JavaScript.statementToCode(block, 'out_sequence');
  var statements_error_sequence = Blockly.JavaScript.statementToCode(block, 'error_sequence');
  // TODO: Assemble JavaScript into code variable.
  var code = '\
<proxy name="'+ value_proxy_name + '" startOnLoad="'+dropdown_start_on_load_dropdown+'" transports="http https" xmlns="http://ws.apache.org/ns/synapse">\n\
    <target>\n\
        <inSequence>\n'
        +statements_in_sequence+'\
        </inSequence>\n\
        <outSequence>\n'
        +statements_out_sequence+'\
        </outSequence>\n\
        <faultSequence>\n'
        +statements_error_sequence+'\
        </faultSequence>\n\
    </target>\n\
</proxy>\n\
  ';
...
Blockly.JavaScript['log_full'] = function(block) {
  var dropdown_category = block.getFieldValue('category');
  // TODO: Assemble JavaScript into code variable.
  var code = '\
<log level="'+dropdown_category+'"/>\n\
  ';
  return code;
};
...
Blockly.Blocks.lists_setIndex = {
    init: function () {
        ...
        var a = Blockly.utils.xml.createElement("mutation"), b = this.getInput("AT").type == Blockly.INPUT_VALUE;
        a.setAttribute("at", b);
        return a
    }, domToMutation: function (a) {
        a = "false" != a.getAttribute("at");
...
Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN = {
    elseifCount_: 0, elseCount_: 0, suppressPrefixSuffix: !0, mutationToDom: function () {
...
Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    ...
    onchange: function (a) {
        if (this.workspace.isDragging && !this.workspace.isDragging() && a.type == Blockly.Events.BLOCK_MOVE && a.blockId == this.id) {
            var b =
                Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.getSurroundLoop(this);
...
Blockly.Constants.Math.IS_DIVISIBLEBY_MUTATOR_MIXIN = {
    mutationToDom: function () {
        var a = Blockly.utils.xml.createElement("mutation"), b = "DIVISIBLE_BY" == this.getFieldValue("PROPERTY");
...
Blockly.Blocks.procedures_defnoreturn = {
    init: function () {
        ...
        if (null !== a && (a = "TRUE" == a, this.hasStatements_ != a)) if (a) this.setStatements_(!0),
            Blockly.Mutator.reconnect(this.statementConnection_, this, "STACK"), this.statementConnection_ = null; else {
        ...
        if (!this.isInFlyout) {
            ...
            a.push(b);
            if (!this.isCollapsed()) for (c = 0; c < this.argumentVarModels_.length; c++) b = {enabled: !0}, d = this.argumentVarModels_[c], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", d.name),
...
Blockly.Blocks.procedures_mutatorarg = {
    init: function () {
        ...
        if (!a) return null;
        for (var d = (b.workspace.targetWorkspace || b.workspace).getAllBlocks(!1), e = a.toLowerCase(), f = 0; f < d.length; f++) if (d[f].id != this.getSourceBlock().id) {
...
Blockly.Blocks.procedures_callnoreturn = {
    init: function () {
        ...
        if (b) if (a.join("\n") == this.arguments_.join("\n")) this.quarkIds_ = b; else {
            ...
            this.updateShape_();
            if (this.quarkIds_ = b) for (e = 0; e < this.arguments_.length; e++) b = this.quarkIds_[e], b in this.quarkConnections_ && (f = this.quarkConnections_[b], Blockly.Mutator.reconnect(f, this, "ARG" + e) || delete this.quarkConnections_[b]);
